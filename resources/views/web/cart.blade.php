            ...
            <div class="col-12">
                           ...
                           {{--  @foreach($items as $item)--}}
                            <tr>
                                <td class="cart_product_img d-flex align-items-center">
                                    <a href="#"><img src="{{ asset('img/' . $items->imagen ) }}" alt=""></a>
                                    <h6><strong>{{ $items->nombre}}</strong></h6>
                                </td>
                                <td class="price"><span>Bs.S {{ $items->precio }}</span></td>
                                <td class="qty">
                                    <div class="quantity">
                                ...
                                <td class="total_price"><span>Bs.S {{ $items->precio }}</span></td>
                            </tr>
                           {{-- @endforeach --}}
                        </tbody>
                    </table>
                ...
                <div class="cart-footer d-flex mt-30">
                    <div class="back-to-shop w-50">
                        <a href="{{ route('tienda') }}">Continue shooping</a>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                <div class="cart-total-area mt-70">
                    ...
                    <a href="{{ route('checkout', $items->id )}}" class="btn karl-checkout-btn">Proceed to checkout</a>
                </div>
            </div>
        </div>
    </div>
